...
import {Facebook,Favorite,WhatsApp} from '@mui/icons-material';
    ...
    return (
        <footer className="bg-gray-100 mt-10 py-10  flex flex-col">
                ...
                <div className="flex flex-col gap-3">
                    ...
                    <div className="flex gap-6">
                        ...
                        <Link target='_blank' href={"https://www.instagram.com/ismaelsabry?igsh=bGYwb2x6N2g3YXNk"}>
                            <InstagramIcon fontSize="large" className='text-red-500 text-4xl' />
                        </Link>
                        <Link target='_blank' href={"https://api.whatsapp.com/send/?phone=212605097089&text&type=phone_number&app_absent=0"}>
                            <WhatsApp fontSize='large' className='text-green-500 text-3xl' />
                        </Link>
            ...
            <div className="flex items-center justify-center pt-5 gap-1">
                ...
                <Favorite className='text-red-600' fontSize='medium' />
                <Link href={"https://www.instagram.com/vnas_trying/"} target='_blank' className='text-orange-500'>Anas_bd</Link>
